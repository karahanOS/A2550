from astro2 import sur_bri_error_list
from astro2 import radius_error_list
...
y_data = np.asarray(sur_bri_error_list)
x_data = np.asarray(radius_error_list)
...
fit_y = beta(x_data, y_data, fit_A, fit_B)
